...
Run `./vendor/bin/phpunit` and `php tests/craft5-feature-matrix.php` after upgrades. For production validation, complete the checklist in `tests/e2e/THERAPY_ORGANICS_E2E.md`.
